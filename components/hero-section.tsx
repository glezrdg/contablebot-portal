    ...
    <section className="pt-32 pb-20 px-4 sm:px-6 lg:px-8">
      <div className="max-w-4xl mx-auto text-center">
        ...
        <p className="text-lg sm:text-xl text-muted-foreground max-w-2xl mx-auto mb-10 leading-relaxed">
          Sube una imagen de tu factura y deja que Contable Bot extraiga todos los datos automáticamente. Organiza tu
          contabilidad sin esfuerzo.
        </p>
              ...
              <div className="grid md:grid-cols-2 gap-8 items-center">
                <div className="bg-muted rounded-xl p-8 flex items-center justify-center border-2 border-dashed border-border">
                  <div className="text-center">
                    ...
                    <p className="text-sm text-muted-foreground">Arrastra tu factura aquí</p>
                  </div>
                </div>
                <div className="space-y-4">
                  <div className="flex items-center gap-3">
                    ...
                    <span className="text-sm font-medium text-foreground">Empresa ABC S.L.</span>
                  </div>
                  <div className="flex items-center gap-3">
                    <div className="w-2 h-2 bg-chart-2 rounded-full" />
                    <span className="text-sm text-muted-foreground">Fecha:</span>
                    <span className="text-sm font-medium text-foreground">15/01/2026</span>
                  </div>
                  <div className="flex items-center gap-3">
                    <div className="w-2 h-2 bg-chart-2 rounded-full" />
                    <span className="text-sm text-muted-foreground">Total:</span>
                    <span className="text-sm font-medium text-foreground">€1,250.00</span>
                  </div>
                  <div className="flex items-center gap-3">
                    <div className="w-2 h-2 bg-chart-2 rounded-full" />
                    <span className="text-sm text-muted-foreground">IVA:</span>
                    <span className="text-sm font-medium text-foreground">€217.50</span>
                  </div>
                </div>
              </div>
            </div>
