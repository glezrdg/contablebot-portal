...
export default function UploadInvoiceModal({
  ...
  return createPortal(
    <>
      ...
      {/* Modal - Solid White with proper scroll container */}
      <div className="fixed left-1/2 top-1/2 -translate-x-1/2 -translate-y-1/2 z-[1101] w-[calc(100%-2rem)] max-w-4xl max-h-[90vh] flex flex-col bg-white dark:bg-slate-900 border border-border rounded-2xl shadow-[0_24px_64px_0_rgba(0,0,0,0.3)]">
        {/* Header - Glassmorphic with Gradient */}
        <div className="flex-shrink-0 flex items-center justify-between p-6 sm:p-8 border-b border-[var(--glass-border)] bg-gradient-to-r from-primary/5 via-primary/10 to-primary/5">
          <div>
        ...
        {/* Content - Enhanced with scroll */}
        <div className="flex-1 min-h-0 overflow-y-auto modal-scrollbar p-6 sm:p-8 space-y-8">
